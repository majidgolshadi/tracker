  ...
  BEGIN
    ...
    ELSE
      ...
      THEN
        SET failed = TRUE;
      ELSE
          INSERT INTO driver_location (id, lat, lon, rev, car_category, `timestamp`) VALUES (in_driver_id, in_lat, in_lon, in_current_rev, in_car_category, in_timestamp);
      END IF;
    END IF;
